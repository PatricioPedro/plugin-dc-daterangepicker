...
(function (root, factory) {
    ...
    var DateRangePicker = function (element, options, cb) {
        ...
        this.container.find('.drp-calendar')
            ...
            .on('mousedown.daterangepicker', 'td', $.proxy(this.clickDate, this))
            .on('mouseenter.daterangepicker', 'td', $.proxy(this.hoverDate, this))
    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (side) {
            ...
            for (var row = 0; row < 6; row++) {
                ...
                for (var col = 0; col < 7; col++) {
                    ...
                    else if (calendar[row][col].isSame(new Date(), "day"))
                        classes.push('today');
                    ...
                    html += '<td class="' + cname.replace(/^\s+|\s+$/g, '') + '" data-info="' + 'r' + row + 'c' + col + '">' + calendar[row][col].date() + '</td>';
        ...
        hoverDate: function (e) {
            ...
            var title = $(e.target).attr('data-info');
